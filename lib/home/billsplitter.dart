...
class _BillSplitterState extends State<BillSplitter>{
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text("\$${_calculateTotalPerPerson(
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Text(" \$ ${_calculateTotalTip(_billAmount, _personCounter, _tipPercentage)}",
                          style: TextStyle(
                          color: _purple,
                          fontSize: 17.0,
                          fontWeight: FontWeight.bold
  ...
  _calculateTotalPerPerson(double totalTip, double billAmount, int splitBy){
